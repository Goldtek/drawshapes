...
interface propParams {
    x1: string, y1: string, x2: string, y2: string, height: string, width: string, color: string, thickness: number, id: number, ChangeValue: (event: React.MouseEvent<HTMLButtonElement>, id: number)  => void
}

const LineInput = ({x1, y1, x2, y2, height, width, color, thickness, id, ChangeValue}: propParams) => {
